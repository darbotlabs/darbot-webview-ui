...
async function main() {
	...
	try {
		...
		delDir('./test-webview-react/webview-ui/node_modules/darbot-webview-ui/dist');
		createDir('./test-webview-react/webview-ui/node_modules/darbot-webview-ui/dist');
		copyDir('./dist', './test-webview-react/webview-ui/node_modules/darbot-webview-ui');
		// Copy react build directory
		delDir('./test-webview-react/webview-ui/node_modules/darbot-webview-ui/react');
		createDir('./test-webview-react/webview-ui/node_modules/darbot-webview-ui/react');
		copyDir('./react', './test-webview-react/webview-ui/node_modules/darbot-webview-ui');
	} catch (err) {
